...
<div id="show2_<s:property value="comment.id" />"/>
	<div style="width: 545px; margin: 0 0 0 50px; border-top: 1px solid #ddd; padding: 10px 0; float: left; display: inline;">
			...
			<div style="width: 460px; float: right; display: inline;">
				...
				<div
					...
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td align="left"><s:property value="comment1.users.name" /> <s:date name="comment1.createTime" format="yyyy-MM-dd HH:mm" /></td>
							<td align="right">引用内容</td>
						</tr>
						<tr>
							<td colspan="2"><s:property value="comment1.description" /></td>
						</tr>
					</table>
				</div>
				<div>
		...
		<div class="srk" style="width: 84%; float: right; display: none;" id="showList_<s:property value="comment.id"/>">
